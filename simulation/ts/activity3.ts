...
let vbe_dsp: HTMLInputElement;
let vce_dsp: HTMLInputElement;

let extra_vce_dsp: HTMLInputElement;
let extra_ib_dsp: HTMLInputElement;
...
function add_offcanvas_table(x: any) {
	x.addoffcanvas(4);
	x.addoffcanvas(5);

	let bsOffcanvas4 = document.getElementById('offcanvasRight4');
	let pn = document.getElementById('pannel4');
	let btn1: HTMLButtonElement = <HTMLButtonElement> document.getElementsByClassName('offcanvasbtn')[1];
	//bsOffcanvas.show();
	...
	let btn15: HTMLButtonElement = <HTMLButtonElement> document.getElementsByClassName('offcanvasbtn')[2];
	//bsOffcanvas.show();
	//bsOffcanvas4.style.position = 'relative';
	...
	let parent: HTMLDivElement = <HTMLDivElement> document.getElementById('out_obst');
	
	let parent1: HTMLDivElement = <HTMLDivElement> document.getElementById('obst');  
...
function power_button() {
	let btn: HTMLInputElement = <HTMLInputElement> document.getElementById('power-dsp');
	let btn1: HTMLInputElement = <HTMLInputElement> document.getElementById('record-btn');
	let heading: HTMLHeadingElement = <HTMLHeadingElement> document.getElementById('act1-sim-heading');
	let inp_control: HTMLDivElement = <HTMLDivElement> document.getElementById('inp-control');
	let out_control: HTMLDivElement = <HTMLDivElement> document.getElementById('out-control');
	current_ele = <HTMLInputElement> document.getElementById('i-dsp');
	l_ele = <HTMLInputElement> document.getElementById('l-dsp');
	x_ele = <HTMLSpanElement> document.getElementById('x-dsp');

	ib_dsp = <HTMLInputElement> document.getElementById('microa-dsp');
	ic_dsp = <HTMLInputElement> document.getElementById('millia-dsp');
	vbe_dsp = <HTMLInputElement> document.getElementById('vbe-dsp');
	vce_dsp = <HTMLInputElement> document.getElementById('vce-dsp');

	extra_vce_dsp = <HTMLInputElement> document.getElementById('extra-vce');
	extra_ib_dsp = <HTMLInputElement> document.getElementById('extra-ib');

	record_btn = <HTMLButtonElement> document.getElementById('record-btn');
...
function set_first_constant() {
	...
	let t: HTMLSpanElement = <HTMLSpanElement> document.getElementById('off-vce');

	let btn: HTMLInputElement = <HTMLInputElement> document.getElementById('power-dsp');
	let btn1: HTMLButtonElement = <HTMLButtonElement> document.getElementById('fbtn1');
	let btn2: HTMLButtonElement = <HTMLButtonElement> document.getElementById('fbtn2');
	let btn3: HTMLButtonElement = <HTMLButtonElement> document.getElementById('qa-we');
...
function set_second_constant() {
	...
	let t: HTMLSpanElement = <HTMLSpanElement> document.getElementById('off-ib');

	let btn: HTMLInputElement = <HTMLInputElement> document.getElementById('power-dsp');

	let btn1: HTMLButtonElement = <HTMLButtonElement> document.getElementById('sbtn1');
	let btn2: HTMLButtonElement = <HTMLButtonElement> document.getElementById('sbtn2');
	let btn3: HTMLButtonElement = <HTMLButtonElement> document.getElementById('qa-wa');
...
function record_observation() {
	...
	let parent: HTMLDivElement = <HTMLDivElement> document.getElementById('obst');
	...
	var bsOffcanvas = new bootstrap.Offcanvas(
		document.getElementById('offcanvasRight5')
	);
	bsOffcanvas.show();
}
...
function disable_buttons() {
	...
	let btn1: HTMLButtonElement = <HTMLButtonElement> document.getElementById('f-plus');
	let btn2: HTMLButtonElement = <HTMLButtonElement> document.getElementById('f-minus');
